      ...
      <ScrollView>
        <ContainerForm>
          ...
          <InputBox>
            ...
            <Input
              placeholder="Ex: Disponivel para adoção"
              value={title}
          ...
          <SubmitButton style={{ marginTop: 20, marginBottom: 20 }}>
            ...
            <TextSimple style={{ fontSize: 28, color: "#fff" }}>
              Criar anúncio
            </TextSimple>
          </SubmitButton>

          <TextSimple style={{ fontSize: 20 }}>
            Publicando, voce aceita os Termos de Utilização e Privacidade desse
            aplicativo
          </TextSimple>
        </ContainerForm>
      </ScrollView>
